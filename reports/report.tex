...
\begin{enumerate}
  ...
  位置：\codepath{D:/code/PythonWithPycharm/DataMining/code_assistant/my_repo/tests/test_math_utils.py:5} \\
  说明：Use of assert detected. The enclosed code will be removed when compiling to optimised byte code.

  \item \textbf{[low] bandit B101} \\
  位置：\codepath{D:/code/PythonWithPycharm/DataMining/code_assistant/my_repo/tests/test_math_utils.py:8} \\
  说明：Use of assert detected. The enclosed code will be removed when compiling to optimised byte code.
...
\bottomrule
\endlastfoot
\codepath{D:/code/PythonWithPycharm/DataMining/code_assistant/my_repo/tests/test_math_utils.py} & F & \codepath{test_add} & A & 2 \\
\codepath{D:/code/PythonWithPycharm/DataMining/code_assistant/my_repo/tests/test_math_utils.py} & F & \codepath{test_div} & A & 2 \\
\codepath{D:/code/PythonWithPycharm/DataMining/code_assistant/my_repo/tests/test_math_utils.py} & F & \codepath{test_div_zero} & A & 1 \\
\end{longtable}
\normalsize
...
\begin{itemize}
  \item 写入测试文件数：4
  \item 覆盖函数数：7
  \item 输出目录：\codepath{D:/code/PythonWithPycharm/DataMining/code_assistant/generated_tests}
\end{itemize}
