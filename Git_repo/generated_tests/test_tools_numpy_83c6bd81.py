...
MOD_PATH = Path(__file__).parent / '_notebooks/nb_tools_numpy_83c6bd81.py'
MOD_NAME = 'nb_tools_numpy_83c6bd81'
...
def test_my_function__basic_smoke():
    try:
        out = getattr(MOD, 'my_function')(None, None, None)
    except TypeError:
...
def test_my_function__edge_cases():
    # TODO: add domain-specific edge cases when known
    assert True

@given(st.integers(), st.integers())
def test_my_function__property_based(a, b):
    try:
        _ = getattr(MOD, 'my_function')(a, b)
    except TypeError:
